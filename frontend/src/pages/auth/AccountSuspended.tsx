    ...
    <div className="flex min-h-screen items-center justify-center bg-amber-50 px-4 py-8">
      <div className="w-full max-w-[560px]">
        ...
        <div className="rounded-2xl bg-white shadow-xl">
          <div className="border-l-4 border-amber-500 rounded-l-2xl p-6">
            <h1 className="text-center text-2xl font-bold text-gray-900">Account Suspended</h1>
            <p className="mt-2 text-center text-gray-600">Your access has been temporarily restricted.</p>
            ...
            {details ? (
              <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5">
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-xs font-medium uppercase tracking-wide text-gray-500">Suspended On</p>
                    <p className="mt-1 text-gray-900">{formatDate(details.suspended_at)}</p>
                  </div>
                </div>
              </div>
            ) : (
              <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5">
                <p className="text-gray-600">Your account has been suspended. Please contact the administrator for more information.</p>
              </div>
            )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please explain why you believe this suspension should be lifted... (min 30 characters)"
                  ...
                  <Button type="submit" className="w-full" disabled={submitting || message.length < 30}>
